...
export const metadata = {
  title: "Data Tables | Global Import Lab",
  description: "Evidence tables for import product claims, prices, variants, and country-risk checks."
};

export default async function DataIndexPage() {
  const articles = (await getAllArticles())
    .filter((article) => article.type === "data" && article.publishStatus === "published")
    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <header className="max-w-3xl">
          <p className="text-sm font-semibold uppercase text-teal-700">Evidence tables</p>
          <h1 className="mt-3 text-4xl font-semibold">Data tables</h1>
          <p className="mt-3 text-neutral-700">
            Structured rows behind reviews, comparisons, price truth, and variant-risk pages.
          </p>
        </header>
