...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: `Contact | ${trendSiteName}`,
    description: `Contact ${trendSiteName} about brief corrections, privacy requests, and partnership questions.`,
    alternates: {
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 text-neutral-900">
        ...
        <div className="mt-[25px] space-y-[25px] text-[15px] leading-[21px] text-neutral-800 md:text-base md:leading-6">
          <p>
            For product corrections, privacy requests, affiliate questions, or
          ...
          <p>
            Include the brief URL, product name, marketplace link, and the issue
            you want checked. For privacy requests, include the email address or
            browser/session detail needed to identify the request.
          </p>
        </div>
      </main>
      <SiteFooter />
