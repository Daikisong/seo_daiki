...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Do Not Sell or Share My Personal Information | TREND - Jacob",
    description: "Privacy choice page for TREND - Jacob.",
    alternates: {
...
export default function DoNotSellOrSharePage() {
  return (
    <>
      <SiteHeader currentHref="/do-not-sell-or-share/" />
      <main className="mx-auto max-w-3xl px-4 py-10 text-neutral-900">
        ...
        <div className="mt-[25px] space-y-[25px] text-[15px] leading-[21px] text-neutral-800 md:text-base md:leading-6">
          <p>
            TREND - Jacob does not sell personal information for money. Some analytics, advertising, or affiliate
            tracking tools may be considered sharing under certain privacy laws.
          </p>
          <p>
            To limit sharing, use browser privacy controls, block third-party cookies, or avoid outbound marketplace
            links that route through affiliate tracking.
          </p>
          <p>
            ...
            . Include the browser, device, and any email address needed to identify the request.
          </p>
        </div>
      </main>
      <SiteFooter />
