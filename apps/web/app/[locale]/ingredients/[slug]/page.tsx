...
export function generateStaticParams() {
  return staticParamsForLocalizedSection("ingredient_guide", "ingredients");
}
...
export default async function IngredientGuidePage({ params, searchParams }: PageProps) {
  const page = await loadArticlePageForLocalizedSection(params, "ingredient_guide", "ingredients", searchParams);
