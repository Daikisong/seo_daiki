...
import { getIndexedArticles, getStaticTrendParams, getTrendArticle, getTrendProducts } from "@/lib/trend-site/data";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const languages = articleLanguageAlternates(article, getIndexedArticles(), new URL(canonicalUrl).origin);
