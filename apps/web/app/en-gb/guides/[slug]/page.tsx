...
export function generateMetadata({ params, searchParams }: PageProps) {
  return generateCountryRiskGuideMetadata(params, "en-gb", "guides", searchParams);
}

export default async function UkCountryRiskGuidePage({ params, searchParams }: PageProps) {
  const page = await loadCountryRiskGuidePage(params, "en-gb", "guides", searchParams);
