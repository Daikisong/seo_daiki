...
export const europeHeatwaveProductRecords: ProductRecord[] = [
  ...
  },
  {
    ...
    brandClaim: "Meaco",
    rankLabel: "Best UK bedroom and office route",
    watts: "10000",
    verifiedClaimType: "cooling-capacity",
    verifiedClaimUnit: "BTU",
    price: 399.99,
    ...
    specSummary:
      "B&Q lists the MeacoCool MC Series Pro 10000 BTU model as a UK portable AC route with 220-240 V support and mainstream retailer handling.",
    reviewSummary:
  ...
  },
  {
    ...
    voltagePlug: "220-240 V UK route; confirm plug, stock status, and warranty",
    returnRiskLabel: "Availability and heavy-goods return risk",
    specSummary:
      "Duux North 9K is a smart portable AC class product with cooling, heating, dehumidifying, remote/app control, and a listed 220-240 V route.",
    reviewSummary:
  ...
  },
  {
    ...
    marketplaceSourceLabel: "Currys UK retailer route",
    priceCheckedAt: "2026-06-29",
    ...
    voltagePlug: "UK local route; confirm 3-pin plug, delivery, and warranty",
  ...
  },
  {
    ...
    brandClaim: "electriQ",
    rankLabel: "Best UK high-capacity local route",
    watts: "14000",
    verifiedClaimType: "cooling-capacity",
    verifiedClaimUnit: "BTU",
    price: 0,
