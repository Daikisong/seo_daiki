...
export const baseDataDraftSpecs: BaseDataDraftSpec[] = [
  {
    ...
    sectionHeadings: ["Methodology", "Benchmark table", "Suspicious claim gaps", "Dataset download", "Update log"],
  ...
  },
  {
    ...
    sectionHeadings: ["Dataset scope", "E-marker evidence", "Length and SKU traps", "Price truth", "Reusable evidence"],
  ...
  },
  {
    ...
    sectionHeadings: ["Dataset scope", "mAh versus Wh", "USB-C output evidence", "Shipping and return risk", "Reusable evidence"],
    evidenceIds: [
  ...
  },
  {
    ...
    sectionHeadings: ["Test method", "Load result", "Temperature note", "Profile capture", "Reusable evidence"],
