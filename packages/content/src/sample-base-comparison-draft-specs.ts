...
export const baseComparisonDraftSpecs: BaseComparisonDraftSpec[] = [
  {
    ...
    sectionHeadings: ["Comparison table", "Verified output gap", "Cable requirement", "Price zones", "Who should avoid each"],
  ...
  },
  {
    ...
    sectionHeadings: ["Comparison rule", "Price gap", "Return and certification risk", "When local wins", "Evidence"],
