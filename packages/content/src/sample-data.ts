...
const draftArticles: ArticleDraft[] = [...baseDraftArticles, ...generatedDraftArticles];

const linkableArticleTypes: ArticleType[] = ["hub", "methodology", "risk", "data", "lab", "compare", "guide", "review"];
